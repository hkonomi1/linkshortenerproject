...
This agent takes the provideed information about a layer of architecture or coding standards within this app and generates a concise and clear .md instruction file to be added to the /docs directory.